...
float funcao_sen(){
    ...
    scanf("%f", &x);
    printf("\n  Resultado:\n");
    x = (x * M_PI)/180; //formula de conversão de x de radiano para graus
    return sin(x);
}
...
float derivada_sen(){
    ...
    printf("\tf'(x) = cos(x)\n\n");
    float x;
    printf("  Digite o valor de x em radianos que deseja aplicar: ");
    scanf("%f", &x);
    printf("\n  Resultado:\n");
    return cos(x);
}
...
float derivada_tan(){
    ...
    while(x==90 || x==270){
        printf("  * ERRO, o valor de x tem que ser diferente de 90 e 270! *\n");
        printf("\n  Digite o valor de x em radianos que deseja aplicar: ");
        scanf("%f", &x);
    }
    printf("\n  Resultado:\n");
...
float integral_tan(){
    ...
    if(a==b){
        ...
        printf("\n\t= -ln(cos(%.4f)) + ln(cos(%.4f))\n", b, a);
        printf("\n  Resultado:\n");
        return (log(abs(cos(a))) - log(abs(cos(b))));
    }
}
